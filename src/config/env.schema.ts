...
export const envSchema = z.object({
  ...
  CUSTOMER_JWT_ACCESS_SECRET: z.string().min(16),
  CUSTOMER_JWT_REFRESH_SECRET: z.string().min(16),
  CUSTOMER_JWT_ACCESS_EXPIRES: z.string().default('15m'),
  CUSTOMER_JWT_REFRESH_EXPIRES: z.string().default('7d'),
